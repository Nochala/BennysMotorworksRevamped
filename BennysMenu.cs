...
namespace BennysMotorworksRevamped
{
    public class BennysMenu : Script
    {
        ...
        public BennysMenu()
        {
            ...
            string doorLabel = Game.GetLocalizedString("CMM_MOD_S6");
            if (string.IsNullOrWhiteSpace(doorLabel) || string.Equals(doorLabel, "NULL", StringComparison.OrdinalIgnoreCase))
            {
                doorLabel = "Doors";
            }
