    ...
    public class UIMenu
    {
        ...
        public UIMenu(string title, string subtitle)
        {
            ...
            NativeMenu.Closed += (sender, args) =>
            {
                ...
                if (restoreParent)
                {
                    bool resetCursorWhenOpened = ParentMenu.NativeMenu.ResetCursorWhenOpened;
                    ParentMenu.NativeMenu.ResetCursorWhenOpened = false;
                    try
                    {
                    ...
                    {
                        ParentMenu.NativeMenu.ResetCursorWhenOpened = resetCursorWhenOpened;
                    }
                }
